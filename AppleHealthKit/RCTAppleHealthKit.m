...
//#import "RCTAppleHealthKit+Methods_Sexual.h"
...
//}
//
//RCT_EXPORT_METHOD(getFitzpatrickSkin:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self characteristic_getFitzpatrickSkin:input callback:callback];
//}
//
...
//}
//
//RCT_EXPORT_METHOD(getDistanceWheelchair:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self fitness_getDistanceWheelchair:input callback:callback];
//}
//
//RCT_EXPORT_METHOD(getSwimmingStrokeCount:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self fitness_getSwimmingStrokeCount:input callback:callback];
//}
//
//RCT_EXPORT_METHOD(getDistanceSwimming:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self fitness_getDistanceSwimming:input callback:callback];
//}

//RCT_EXPORT_METHOD(getBasalEnergyBurned:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self fitness_getBasalEnergyBurned:input callback:callback];
//}
//
//RCT_EXPORT_METHOD(getNikeFuel:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self fitness_getNikeFuel:input callback:callback];
//}
//
...
//{
//    [self fitness_getStandHour:input callback:callback];
//}
...
//}
//
//RCT_EXPORT_METHOD(getBloodPressureSystolic:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self vitals_getBloodPressureSystolic:input callback:callback];
//}
//
//RCT_EXPORT_METHOD(getBloodPressureDiastolic:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self vitals_getBloodPressureDiastolic:input callback:callback];
//}
//
//RCT_EXPORT_METHOD(getInsulinDelivery:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self vitals_getInsulinDelivery:input callback:callback];
//}
//
//RCT_EXPORT_METHOD(getVolume02Max:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self vitals_getVolume02Max:input callback:callback];
//}

//RCT_EXPORT_METHOD(getBasalBodyTemperature:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self vitals_getBasalBodyTemperature:input callback:callback];
//}
...
//{
//    [self category_getSexualActivity:input callback:callback];
//}
//
//RCT_EXPORT_METHOD(getIntermenstrualBleeding:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self category_getIntermenstrualBleeding:input callback:callback];
//}
//
//RCT_EXPORT_METHOD(getMenstrualFlow:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self category_getMenstrualFlow:input callback:callback];
//}
//
//RCT_EXPORT_METHOD(getOvulationTestResult:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self category_getOvulationTestResult:input callback:callback];
//}
//
//RCT_EXPORT_METHOD(getCervicalMucusQuality:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self category_getCervicalMucusQuality:input callback:callback];
//}
//// NUTRITION
//RCT_EXPORT_METHOD(getDietaryEnergyConsumed:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryEnergyConsumed:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietaryFatTotal:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryFatTotal:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietaryFatSaturated:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryFatSaturated:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietaryCholesterol:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryCholesterol:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietaryCarbohydrates:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryCarbohydrates:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietaryFiber:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryFiber:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietarySugar:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietarySugar:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietaryProtein:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryProtein:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietaryCalcium:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryCalcium:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietaryIron:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryIron:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietaryPotassium:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryPotassium:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietaryVitaminA:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryVitaminA:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietaryVitaminC:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryVitaminC:input callback:callback];
//}
//RCT_EXPORT_METHOD(getDietaryVitaminD:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
//{
//    [self nutrition_getDietaryVitaminD:input callback:callback];
//}
